...
@section('content')
    ...
    <section class="bg-gray-100 py-12 px-4">
        <div class="container mx-auto flex flex-wrap">
            ...
            <div class="w-full lg:w-3/5 p-6">
                ...
                <form action="{{ route('contact.store') }}" method="POST" class="space-y-4" onsubmit="onSubmit(event)">
                    ...
                    <div>
                        ...
                        <input type="text" id="nombre" name="nombre" class="w-full p-3 border border-gray-300"
                            placeholder="Tu nombre" required>
                    </div>
                    <div>
                        <label for="email" class="block text-lg font-medium text-gray-700">Email</label>
                        <input type="email" id="email" name="email" class="w-full p-3 border border-gray-300"
                            placeholder="Tu email" required>
                    </div>
                    <div>
                        <label for="telefono" class="block text-lg font-medium text-gray-700">Teléfono</label>
                        <input type="tel" id="telefono" name="telefono" class="w-full p-3 border border-gray-300"
                            placeholder="Tu teléfono" required>
                    </div>
                    <div>
                        <label for="mensaje" class="block text-lg font-medium text-gray-700">Mensaje</label>
                        <textarea id="mensaje" name="mensaje" rows="5" class="w-full p-3 border border-gray-300"
                            placeholder="Escribe tu mensaje aquí..." required></textarea>
                    </div>

                    <button type="submit"
                        class="bg-azul-fondo text-white font-semibold ml-6 py-2 px-4 mb-6 transform transition-all duration-300 hover:scale-110 hover:shadow-2xl hover:shadow-verde-limon hover:bg-verde-limon hover:text-azul-fondo">Enviar
                        Mensaje</button>
                </form>
            </div>
            ...
            <div class="w-full lg:w-2/5 p-6">
                <div class="space-y-6">
                    <h3 class="text-4xl font-bold mb-6">Conéctate con nosotros</h3>

                    <!-- Redes Sociales -->
                    <div class="flex space-x-4">
                        <a href="https://www.linkedin.com/company/wolvexcl/" class="text-blue-600 hover:text-blue-800"
                            target="_blank"><i class="fab fa-linkedin fa-2x"></i></a>
                        <a href="https://web.facebook.com/wolvex.cl/" class="text-blue-500 hover:text-blue-700"
                    ...
                    <div class="space-y-4 mt-6">
                        <div class="flex items-center">
                            ...
                            <span class="text-lg font-medium text-gray-700">+56 9 9674 4719</span>
                        </div>
                        <div class="flex items-center">
